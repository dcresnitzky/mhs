...
class CanvasServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../../vendor/cnvs/easel/public' => public_path('vendor/canvas'),
        ], 'public');
    }
    ...
    {
        $configPath = __DIR__.'/../../vendor/cnvs/easel/config/blog.php';
    ...
    {
        // Load translations...
        $this->loadTranslationsFrom(__DIR__.'/../../resources/lang/canvas', 'canvas');
    }
    ...
    {
        // Load the views...
        $this->loadViewsFrom(__DIR__.'/../resources/views/vendor', 'canvas');

        // Allow publishing view files, with tag: views
        $this->publishes([
            __DIR__.'/../../vendor/cnvs/easel/resources/views/auth' => base_path('resources/views/vendor/canvas/auth'),
            __DIR__.'/../../vendor/cnvs/easel/resources/views/backend' => base_path('resources/views/vendor/canvas/backend'),
            __DIR__.'/../../vendor/cnvs/easel/resources/views/errors' => base_path('resources/views/vendor/canvas/errors'),
            __DIR__.'/../../vendor/cnvs/easel/resources/views/frontend' => base_path('resources/views/vendor/canvas/frontend'),
            __DIR__.'/../../vendor/cnvs/easel/resources/views/shared' => base_path('resources/views/vendor/canvas/shared'),
        ], 'views');
    }
    ...
    {
        // Load the migrations...
        $this->loadMigrationsFrom(__DIR__.'/../../vendor/cnvs/easel/database/migrations');
    }
    ...
    public function register()
    {
        ...
        // Register factories...
        $this->registerEloquentFactoriesFrom(__DIR__.'/../../vendor/cnvs/easel/database/factories');
