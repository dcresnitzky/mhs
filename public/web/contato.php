...
<div style="font-size:15px; font-weight:bold">
  <p><a href="index.html">MHS Global</a></p>
                ...
                <td width="12%" align="center" valign="top"><p class="style1"><a href="areas-de-atuacao.html" class="style2">&Aacute;reas de Atua&ccedil;&atilde;o</a></p></td>
                <td width="17%" align="center" valign="top"><p class="style2"><strong><a href="parcerias.html">Parcerias e Representa&ccedil;&otilde;es</a></strong></p>                  </td>
                <td width="12%" align="center" valign="top"><p class="style2"><strong><a href="novidades.html">Novidades</a></strong></p>                  </td>
                <td width="10%" align="center" valign="top"><p class="style2"><strong><a href="clientes.html">Clientes</a></strong></p></td>
                <td width="10%" align="center" valign="top"><p class="style2"><strong><a href="contato.html">Contato</a></strong></p></td>
                <td width="7%" align="center" valign="middle"><a href="index.html"><img src="imagens/bandeira-brasil.jpg" width="37" height="24" border="0" /></a><a href="en"></a></td>
...
?>
                          <div style="color:#0099FF; font-size:14px; text-align:center">
                            ...
                            <p>Entraremos em contato assim que for poss&iacute;vel.</p>
                          </div>
                        <?php
}
?>
