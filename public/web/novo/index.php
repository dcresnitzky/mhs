...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid header">
      ...
      <ul>
        <li class="dropdown" >
          <a id="lingua_dropdown" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><img src="img/flagbr.png" /> Português<b class="caret"></b></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="en/index.php"><img src="img/flageua.png" /> English</a></li>
      ...
      <ul>
        <li class="dropdown">
          <a id="contato_dropdown" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Entre em contato <b class="caret"></b></a>
          <ul class="dropdown-menu" role="menu" style="width:245px">
            <li>&nbsp;&nbsp;&nbsp;<span class='glyphicon glyphicon-earphone'></span> &nbsp;&nbsp;(011) 98509-8676</li>
    ...
    <div class="side-menu">
      ...
      <ul>
        ...
        <li id="nav_empresa"><a href="javascript:goto('empresa');fecha_menu();">EMPRESA</a></li>
        <li id="nav_portifolio"><a href="javascript:goto('portifolio');fecha_menu();">PORTIFÓLIO</a></li>
        <li id="nav_clientes"><a href="javascript:goto('clientes');fecha_menu();">CLIENTES</a></li>
        <li id="nav_contato"><a href="javascript:goto('contato');fecha_menu();">CONTATO</a></li>
      </ul>
      <div class='footer'>
      Copyright MHS Global 2015
      <br>Desenvolvido por <a href="http://br.linkedin.com/in/dcresnitzky" target="_BLANK" >Daniel Resnitzky</a>
      </div>
    </div>
    <div class="overlay-texto">INOVAÇÃO<BR>& TECNOLOGIA</div>
    <section id="home" name="HOME">
        <img src="img/mapa.png">
    </section>    
    <section id="empresa" name="EMPRESA">
      <div class="container-fluid"></div>
    </section>    
    <section id="portifolio" name="PORIFÓLIO">
      <div class="container-fluid"></div>
    </section>    
  ...
  <script type='text/javascript'>
    ...
    function detectaSection(){
      ...
      } else if (onde_estou.html() != 'HOME' && onde_estou.html() != 'EMPRESA' ){
        $('#menu-upfast').css('opacity','1');
        $('#menu-up').css('opacity','1');
      }  else{
        $('#menu-up').css('opacity','1');
      }
      if (onde_estou.html() == 'CONTATO' ){
